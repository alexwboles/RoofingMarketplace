...
function LeadCard({ lead, onStatusChange, onBidUpdate, navigate }) {
           ...
           <Tabs defaultValue="projects">
            ...
            <TabsContent value="projects">
             ...
             <TabsContent value="new_leads">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {newLeads.map((lead) => <LeadCard key={lead.id} lead={lead} onStatusChange={handleStatusChange} onBidUpdate={() => queryClient.invalidateQueries({ queryKey: ["leads"] })} navigate={navigate} />)}
            ...
            <TabsContent value="leads">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {leads.map((lead) => <LeadCard key={lead.id} lead={lead} onStatusChange={handleStatusChange} onBidUpdate={() => queryClient.invalidateQueries({ queryKey: ["leads"] })} navigate={navigate} />)}
